...
public class ApplicationContextExtendsFindsTest {
...
//        DiscountPolicy bean = context.getBean(DiscountPolicy.class);
    ...
    void findBeanByParentType() {
        Map<String, DiscountPolicy> beanTypes = context.getBeansOfType(DiscountPolicy.class);
        assertThat(beanTypes.size()).isEqualTo(2);
        for (String key : beanTypes.keySet()) {
            System.out.println("Key : " + key + ", value : " + beanTypes.get(key));
        }
    }
